...
Simply following current [integration guide](../integrating/overview.mdx) to integrate Velopack into your application. Make sure the `UpdateManager` is configured to use the `VelopackFlowSource` as the `IUpdateSource`. This is the default behavior of the default constructor.
