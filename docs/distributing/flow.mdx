...
- Simple disabling of individual releases: If a release is found to be problematic, you can disable it and prevent users from receiving it.
...
vpk login
```
For more details on interacting with Flow through the `vpk` CLI see [Flow Details](flow-details.mdx).
